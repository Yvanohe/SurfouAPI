...
-- Insert into user_account (password decode : Pa$$w0rd):
Insert into user_account (username, password, email, role_id) values ('admin','$2y$10$6JpiO04cwlArgiYZTePa2.u700njivqFw6e4bzvSYaMd3IhQ0lGV6','y.lubac@gmail.com',1);
