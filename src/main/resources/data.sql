...
Insert into user_account (username, password, email) values ('admin','Pa$$w0rd','y.lubac@gmail.com');
Insert into user_account (username, password, email) values ('toto','titi','toto@titi.com');
